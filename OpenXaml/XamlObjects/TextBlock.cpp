...
namespace OpenXaml::Objects
{
    void TextBlock::Draw()
    {
        ...
        glDrawElements(GL_TRIANGLES, 6 * glyphCount, GL_UNSIGNED_SHORT, nullptr);
    }
    ...
    void TextBlock::Update()
    {
        ...
        auto *eBuffer = (unsigned short *)calloc(6 * charsToRender, sizeof(unsigned short));
    ...
    {
        this->FontFamily = std::move(family);
    }
    ...
    float TextBlock::getFontSize() const
    {
    ...
    unsigned int TextBlock::getFill() const
    {
        return this->Fill;
    }
